...
function CommDKP:ZeroSumBank_Create()
    ...
    f.Balance:SetBackdrop({
      bgFile   = "Textures\\white.blp", tile = true,
      edgeFile = "Interface\\AddOns\\FiftyFiftyDKP\\Media\\Textures\\slider-border", tile = true, tileSize = 1, edgeSize = 2, 
    });
	...
	f.Distribute = CreateFrame("Button", "CommDKPBiddingDistributeButton", f, "FiftyFiftyDKPButtonTemplate")
