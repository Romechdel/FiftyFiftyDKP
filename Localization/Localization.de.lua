if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    CommDKPSCALESIZETTDESC = "Maßstab des FiftyFiftyDKP-Fensters. Klicken Sie auf \"Save Settings\" (Einstellungen speichern), um die Größe auf den eingestellten Wert zu ändern.",
    ...
    OUTOFDATE = "veraltet",
    OUTOFDATEANNOUNCE = "Ihre Version von FiftyFiftyDKP ist veraltet. Bitte aktualisieren Sie Curse / Twitch oder WoWInterface, um sicherzustellen, dass keine Kompatibilitätsprobleme vorliegen.",
    ...
    MIGRATIONDETECTED     = "FiftyFiftyDKP hat ein aktives MonolithDKP-Addon entdeckt.|n|nMöchten Sie die aktuellen Tabellen und Einstellungen zu FiftyFiftyDKP migrieren?",
    MIGRATIONTEAM         = "FiftyFiftyDKP hat ein aktives MonolithDKP-Addon entdeckt.|n|nMöchten Sie die aktuellen Tabellen und Einstellungen|nals NEUES TEAM für deine aktuelle GILDE|nzu FiftyFiftyDKP migrieren?",
    MIGRATIONUNAVAILABLE  = "Bitte deaktivieren Sie MonolithDKP und laden Sie das UI (/reload) neu, wenn Sie mit FiftyFiftyDKP fortfahren möchten.",
    MIGRATIONCONFIRM      = "Dadurch werden Ihre bestehenden FiftyFiftyDKP-Tabellen und Einstellungen überschrieben.|n|n Wollen Sie fortfahren?",
    MIGRATIONCANCELED     = "Migration abgebrochen.|n|nBitte deaktivieren Sie MonolithDKP und laden Sie die Benutzeroberfläche neu (/reload), wenn Sie mit FiftyFiftyDKP fortfahren möchten, ohne Ihre aktuellen Tabellen und Einstellungen zu verwenden.",
