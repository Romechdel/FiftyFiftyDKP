...
core.L = {
  ...
  CommDKPSCALESIZETTDESC = "Scale of the FiftyFiftyDKP window. Click \"Save Settings\" to change size to set value.",
  ...
  OUTOFDATEANNOUNCE = "Your version of FiftyFiftyDKP is out-of-date. Please update on Curse/Twitch or WoWInterface to ensure there are no compatibility issues.",
  ...
  MIGRATIONDETECTED     = "FiftyFiftyDKP has detected an active MonolithDKP addon.|n|nDo you want to migrate its current tables and settings to FiftyFiftyDKP?",
  MIGRATIONTEAM         = "FiftyFiftyDKP has detected an active MonolithDKP addon.|n|nDo you want to migrate its current tables|nas a NEW TEAM for your current GUILD|nto FiftyFiftyDKP?",
  MIGRATIONUNAVAILABLE  = "Please disable MonolithDKP and /reload the UI if you want to continue with FiftyFiftyDKP.",
  MIGRATIONCONFIRM      = "This will overwrite your existing FiftyFiftyDKP tables and settings.|n|nDo you want to continue?",
  MIGRATIONCANCELED     = "Migration canceled.|n|nPlease disable MonolithDKP and /reload the UI if you want to continue with FiftyFiftyDKP without using your current tables and settings.",
